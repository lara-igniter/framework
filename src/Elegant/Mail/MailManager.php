...
use Elegant\Contracts\Mail\Factory as FactoryContract;
use Elegant\Mail\Transport\ArrayTransport;
use Elegant\Mail\Transport\MailgunTransport;
use Elegant\Mail\Transport\SesTransport;
...
class MailManager implements FactoryContract
{
    ...
    protected function createSendmailTransport(array $config)
    {
        return new SendmailTransport(
            $config['path'] ?? $this->app->config['mail']['sendmail']
        );
    }
     ...
     *
     * @param array $config
     * @return \Elegant\Mail\Transport\SesTransport
     */
    protected function createSesTransport(array $config)
    {
        if (!isset($config['secret'])) {
            $config = array_merge($this->app->config['services']['ses'] ?? [], [
     ...
     *
     * @param array $config
     * @return \Elegant\Mail\Transport\MailgunTransport
     */
     ...
     *
     * @return \Elegant\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param \Elegant\Mail\Mailer $mailer
     * @param array $config
     * @param string $type
     * @return void
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any Laraigniter style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the Laraigniter mail configuration file for backwards compatibility.
