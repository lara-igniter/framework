...
use ArrayAccess;
use Countable;
use Elegant\Contracts\Pagination\LengthAwarePaginator as LengthAwarePaginatorContract;
...
class LengthAwarePaginator extends AbstractPaginator implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable, LengthAwarePaginatorContract
{
     ...
     */
    public function links(string $view = null, array $data = []): \Elegant\Contracts\View\View
    {
     ...
     * @return \Elegant\Contracts\View\View
     */
    public function render(string $view = null, array $data = []): \Elegant\Contracts\View\View
    {
