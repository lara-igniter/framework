...
use ArrayAccess;
use Countable;
use Elegant\Contracts\Pagination\Paginator as PaginatorContract;
...
class Paginator extends AbstractPaginator implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable, PaginatorContract
{
    ...
    /**
     * Manually indicate that the paginator does or does not have more pages beyond the current page.
     *
     * @param bool $hasMore
     * @return $this
     */
