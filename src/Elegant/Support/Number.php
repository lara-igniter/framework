...
class Number
{
     ...
     * @return string|false
     */
    public static function format($number, ?int $precision = null, ?int $maxPrecision = null, ?string $locale = null)
    {
     ...
     * @return string
     */
    public static function spell($number, ?string $locale = null, ?int $after = null, ?int $until = null)
    {
        static::ensureIntlExtensionIsInstalled();

        if (! is_null($after) && $number <= $after) {
            return static::format($number, null, null, $locale);
        }
     ...
     * @return string|false
     */
    public static function percentage($number, int $precision = 0, ?int $maxPrecision = null, ?string $locale = null)
    {
        static::ensureIntlExtensionIsInstalled();
     ...
     * @return string
     */
    public static function fileSize($bytes, int $precision = 0, ?int $maxPrecision = null): string
    {
     ...
     * @return bool|string
     */
    public static function abbreviate($number, int $precision = 0, ?int $maxPrecision = null)
    {
        return static::forHumans($number, $precision, $maxPrecision, true);
    }
     ...
     * @return bool|string
     */
    public static function forHumans($number, int $precision = 0, ?int $maxPrecision = null, bool $abbreviate = false)
    {
     ...
     * @return string|false
     */
    protected static function summarize($number, int $precision = 0, ?int $maxPrecision = null, array $units = [])
    {
        if (empty($units)) {
            $units = [
                3 => 'K',
