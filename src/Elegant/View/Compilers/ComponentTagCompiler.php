...
use Elegant\View\AnonymousComponent;
use Elegant\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \Elegant\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     *
     * @param  array  $aliases
     * @param  \Elegant\View\Compilers\BladeCompiler|null
     * @return void
     */
...
<?php $component->withAttributes(['.$this->attributesToString($attributes->all()).']); ?>';
    ...
    public function guessClassName(string $component)
    {
        ...
        return 'App\\View\\Components\\'.implode('\\', $componentPieces);
    }
        ...
        return collect($attributes)
            ->map(function (string $value, string $attribute) use ($escapeBound) {
                return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                    ? "'{$attribute}' => \Elegant\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                    : "'{$attribute}' => {$value}";
            })
            ->implode(',');
    }
