...
trait CompilesAuthorizations
{
    ...
    protected function compileCan($expression)
    {
        ...
        return '<?php if (app("gate")->check' . $ability . ', ' . $arguments . '): ?>';
    }
    ...
    {
        [$ability, $arguments] = explode(',', $expression);
        return '<?php if (app("gate")->denies' . $ability . ', ' . $arguments . '): ?>';
    }
    ...
    {
        [$ability, $arguments] = explode(',', $expression);
        return '<?php if (app("gate")->any' . $ability . ', ' . $arguments . '): ?>';
    }
    ...
    {
        [$ability, $arguments] = explode(',', $expression);
        return '<?php elseif (app("gate")->check' . $ability . ', ' . $arguments . '): ?>';
    }
    ...
    {
        [$ability, $arguments] = explode(',', $expression);
        return '<?php elseif (app("gate")->denies' . $ability . ', ' . $arguments . '): ?>';
    }
    ...
    {
        [$ability, $arguments] = explode(',', $expression);
        return '<?php elseif (app("gate")->any' . $ability . ', ' . $arguments . '): ?>';
    }
