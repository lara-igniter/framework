...
abstract class Component
{
     ...
     *
     * @var \Elegant\View\ComponentAttributeBag
     */
    public $attributes;
     ...
     *
     * @return \Elegant\View\View|\Closure|string
     */
     ...
     *
     * @param  \Elegant\Contracts\View\Factory  $factory
    ...
    protected function createBladeViewFromString($factory, $contents)
    {
        ...
        $factory->addNamespace(
            '__components',
            $directory = app('config')->item('compiled', 'view')
        );
     ...
     *
     * @param  string  $method
     * @return \Elegant\View\InvokableComponentVariable
     */
