...
# Tag Components
for REMOTE in collections contracts filesystem macroable routing support view
do
    echo ""
    echo ""
    echo "Releasing $REMOTE";

    TMP_DIR="/tmp/laraigniter-split"
    REMOTE_URL="https://github.com/lara-elegant//$REMOTE.git"
